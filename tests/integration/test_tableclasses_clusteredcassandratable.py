...
class TestClusteredCassandraTable:
    ...
    def test_crud(self, db_session, db_keyspace):
        table_name = "test_table_clusteredcassandratable"
        ...
        assert gotten1 == {"row_id": "reg_row", "partition_id": "my_part", "body_blob": "reg_blob"}
        ...
        assert gotten2 == {"row_id": "irr_row", "partition_id": "other_p", "body_blob": "irr_blob"}
        #
